...
public class ProbabilityGenerator<E> {
	...
	void trainPitches(ArrayList<E> elements) {
		//tally up the notes
		System.out.println("noteArray: " + elements);
	...
	void trainRhythms(ArrayList<Double> elements) {
		...
		System.out.println("rhythmArray: " + elements);
		for (int i = 0; i < elements.size(); i++) {
			if (rhythms.size() == 0) {
		...
		System.out.println("rhythmInstances: " + rhythmInstances);
		...
		System.out.println("rhythmProbabilities: " + rhythmProbabilities);
	}
